...
def test_convert_kilopascals_to_psi():
    assert convert_kilopascals_to_psi(0) == approx(0, abs=0.001)
    assert convert_kilopascals_to_psi(100) == approx(14.5038, abs=0.001)
    assert convert_kilopascals_to_psi(200) == approx(29.0076, abs=0.001)
    assert convert_kilopascals_to_psi(500) == approx(72.5194, abs=0.001)
    assert convert_kilopascals_to_psi(1000) == approx(145.038, abs=0.001)
